...
def main():
    try:
        ...
        while True:
            ...
            # Convert voltage to PPM (based on calibration: 50nA/ppm, 15nA offset)
            # For now, assume linear: 1V = 10 ppm (adjust based on calibration)
            ethylene_ppm = average_voltage * 8.5  # Example: 1.2 V = ~10.2 ppm
